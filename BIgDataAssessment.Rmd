...
The above tree was plotted using the dotTree function, and the population performance variable was added using the mutate function.
...
```
The graph above is made again using the dotTree function, but this time a matrix containing population performance and IUCN information is used to show both factors. There does not seem to be a clear correlation between the two, suggesting that even populations that are growing can be endangered. 
