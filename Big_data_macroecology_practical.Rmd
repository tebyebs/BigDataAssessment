...
elim_comadre_iucn <- comadre_iucn[-which(comadre_iucn$OTL_unique_name%in%pruned_tree$tip.label==F),]
dim(elim_comadre_iucn)

#Next, we need to reorder the comadre_iucn order so the species appear in the same order in which they appear in the tree
order_comadre_iucn <- elim_comadre_iucn[match(pruned_tree$tip.label,elim_comadre_iucn$OTL_unique_name),]
dim(order_comadre_iucn)

#Checking that the order is the same between the object and the tree
order_comadre_iucn$OTL_unique_name
...
log_lambdas <- log(setNames(order_comadre_iucn$lambda, rownames(order_comadre_iucn)))
...
log_gen_T <- log(setNames(order_comadre_iucn$gen_T, rownames(order_comadre_iucn)))
